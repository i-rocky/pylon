...
/// negotiation range `MIN_PROTOCOL..=MAX_PROTOCOL` (`[7]` today). Cluster-wide
/// shared frames encode at `ACTIVE_VERSIONS[0]` until 7.3 makes fan-out
/// per-version.
...
///
/// # Panics
/// On a `version` outside `MIN_PROTOCOL..=MAX_PROTOCOL`. Callers pass either a
/// codec-negotiated version ([`crate::protocol::codec::Codec::version`]) or an
